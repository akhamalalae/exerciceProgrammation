...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(new \App\Service\Api(($container->privates['.debug.http_client'] ?? $container->get_Debug_HttpClientService()))), 'groups' => []]]);
